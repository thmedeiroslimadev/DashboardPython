...
def extract_all_messages(zip_path, output_csv, responses_csv):
    ...
    try:
        ...
        logging.info(f"Responses saved to: {responses_csv}")
    except Exception as e:
        logging.info(f"Failed to save responses CSV file: {e}")
...
if __name__ == "__main__":
    ...
    output_file = "uploads/whatsapp_messages.csv"
    responses_file = "uploads/responses_to_chamados.csv"
